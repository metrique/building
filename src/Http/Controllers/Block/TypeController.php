...
// use TG\Http\Requests\Cms\BlockTypeRequest;
...
class TypeController extends Controller
{
    ...
    public function index(TypeRepository $type)
    {
        ...
        return view('cms.building.block.type.index')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view('cms.building.block.type.create')->with($data);
    }
     ...
     * @return Response
     */
    public function store(BlockTypeRequest $request, TypeRepository $type)
    {
        $type->create([
    ...
    public function edit($id, TypeRepository $type)
    {
        ...
        return view('cms.building.block.type.edit')->with($data);
    }
     ...
     * @return Response
     */
    public function update(BlockTypeRequest $request, $id, TypeRepository $type)
    {
        //
            $type->update($id, [
                'title' => $request->input('title'),
